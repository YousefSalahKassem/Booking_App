...
import 'package:bookingapp/src/features/search_explore/presentation/cubit/create_booking/booking_state.dart';
...
class BookingCubit extends Cubit<BookingState> {
  ...
  BookingCubit({required this.createBookingUseCase, required this.updateBookingUseCase})
      : super(StatusInitial());
