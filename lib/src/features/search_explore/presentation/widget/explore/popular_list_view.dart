...
import 'package:bookingapp/src/features/search_explore/presentation/widget/explore/category_view.dart';
...
class PopularListView extends StatefulWidget {
  ...
  const PopularListView({Key? key, required this.callBack, required this.animationController})
      : super(key: key);
