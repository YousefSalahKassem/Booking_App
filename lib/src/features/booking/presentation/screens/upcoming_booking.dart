...
class _UpcomingBookingState extends State<UpcomingBooking> {
  ...
  @override
  void initState() {
    AllBookingCubit.get(context).getAllBookings('upcoming');
                        ...
                        Column(
                          children: <Widget>[
                            AspectRatio(
                              aspectRatio: 2,
                              child: Image.asset(
                                //state.upcomingBookings[index].hotel.images[0].baseImageUrlimage,
                              ...
                              children: <Widget>[
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        Text(
                                          state.upcomingBookings[index].hotel.name,
                                        ...
                                        Text(
                                          state.upcomingBookings[index].hotel.address,
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      Text(
                                        "\$${state.upcomingBookings[index].hotel.price}",
                                        textAlign: TextAlign.left,
                                        style: TextStyles(context)
                                            .getBoldStyle()
                                            .copyWith(fontSize: 22),
