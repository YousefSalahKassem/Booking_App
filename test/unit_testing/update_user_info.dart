...
void main () async {
  ...
  group("check user updated", () {
    ...
    test("user updated successfully", () async {
      final cubit = UpdateUserCubit(updateUser: di.sl() , getUserInfo: di.sl());
      expectLater(cubit.updateInfo(UpdateInfoModel(name: 'Abdullah Mansou', email: 'abdullah.mansour12124@gmail.com')), completes);
    });

    test("user updated failed", () async {
      final cubit = UpdateUserCubit(updateUser: di.sl(), getUserInfo: di.sl());
      expectLater(cubit.updateInfo(UpdateInfoModel(name: 'Abdullah Mansour', email: 'abdullah.mansour@gmail.com')), completes);
    });
